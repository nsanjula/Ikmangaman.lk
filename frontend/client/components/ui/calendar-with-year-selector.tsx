...
export type CalendarWithYearSelectorProps = React.ComponentProps<typeof DayPicker> & {
...
function CalendarWithYearSelector({
  ...
  React.useEffect(() => {
    if (props.selected as Date) {
      setSelectedMonth(props.selected as Date);
    }
  }, [props.selected]);
  ...
  return (
    <div className="p-3">
      ...
      <div className="flex justify-center items-center gap-2 mb-4 pb-3 border-b">
        <Select
...
CalendarWithYearSelector.displayName = "CalendarWithYearSelector";
