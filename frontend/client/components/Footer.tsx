    ...
    <footer className="py-9" style={{ background: 'var(--primary-700)', color: '#B8E6E6' }}>
      <div className="container iframe-container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a
                ...
                onMouseLeave={(e) => e.currentTarget.style.color = '#B8E6E6'}
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold mb-4" style={{ color: '#F0F9FF' }}>Quick Links</h4>
          ...
          {/* Legal */}
          <div>
            <h4 className="text-sm font-semibold mb-4" style={{ color: '#F0F9FF' }}>Legal</h4>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/privacy-policy"
        ...
        <div className="border-t mt-9 pt-6 text-center" style={{ borderColor: '#075985' }}>
          <p className="text-sm" style={{ color: '#B8E6E6' }}>
            © {new Date().getFullYear()} Ikmangaman.lk. All rights reserved. Made with ❤️ for Sri Lanka travelers.
          </p>
        </div>
      </div>
    </footer>
